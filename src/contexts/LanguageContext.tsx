...
const translations = {
    en: {
        ...
        'projectDetail.projectType': 'PROJECT TYPE',
        'projectDetail.teamSize': 'TEAM SIZE',
        'projectDetail.highlights': 'KEY ACHIEVEMENTS',
        'projectDetail.background': 'BACKGROUND',
        'projectDetail.tab.overview': 'OVERVIEW',
        'projectDetail.tab.tasks': 'MY TASKS',
        'projectDetail.tab.troubleshooting': 'PROBLEM SOLVING',
        'projectDetail.tasksTitle': 'MY TASKS & CONTRIBUTIONS',
        'projectDetail.tasksList': 'What I Did',
        'projectDetail.troubleshootingTitle': 'PROBLEM SOLVING',
        'projectDetail.situation': 'Situation',
        'projectDetail.causeAnalysis': 'Root Cause Analysis',
        'projectDetail.approach': 'Solution',
    ...
    ko: {
        ...
        'projectDetail.projectType': '프로젝트 유형',
        'projectDetail.teamSize': '팀 규모',
        'projectDetail.highlights': '핵심 성과',
        'projectDetail.background': '배경',
        'projectDetail.tab.overview': '개요',
        'projectDetail.tab.tasks': '담당 업무',
        'projectDetail.tab.troubleshooting': '문제 해결',
        'projectDetail.tasksTitle': '담당 업무',
        'projectDetail.tasksList': '담당 기능',
        'projectDetail.troubleshootingTitle': '문제 해결',
        'projectDetail.situation': '상황',
        'projectDetail.causeAnalysis': '원인',
        'projectDetail.approach': '해결',
        'projectDetail.result': '결과',
