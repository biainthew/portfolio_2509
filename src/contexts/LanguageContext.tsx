...
const translations = {
    en: {
        ...
        'profile.description':
            'Specialized in creating cutting-edge digital experiences with a focus on interactive interfaces and visual storytelling. Proficient in both front-end development and creative design.',
        ...
        'profile.codeSnippet.line1': 'class CyberDeveloper {',
    ...
    ko: {
        ...
        // Profile
        'profile.title': '스킬 매트릭스',
        'profile.description':
            '인터랙티브 인터페이스와 시각적 스토리텔링에 중점을 둔 최첨단 디지털 경험 제작 전문. 프론트엔드 개발과 창의적 디자인 모두 능숙.',
        'profile.category.frontend': '프론트엔드',
        'profile.category.design': '디자인',
        'profile.category.backend': '백엔드',
        'profile.status': '상태',
        'profile.statusValue': '온라인',
        'profile.codeSnippet.line1': 'class 사이버개발자 {',
        'profile.codeSnippet.line2': '  constructor() {',
        'profile.codeSnippet.line3': '    this.열정 = "창의적 코딩";',
        'profile.codeSnippet.line4': '  }',
        // Projects
        'projects.title': '프로젝트',
